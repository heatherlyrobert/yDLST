...
char
ydlst_active__hook      (tDLST_LINE *a_line)
{
   /*---(locals)-----------+-----+-----+-*/
   int         rce         =  -10;
   /*---(header)-------------------------*/
...
char
ydlst_active__unhook    (tDLST_LINE *a_line)
{
   /*---(locals)-----------+-----+-----+-*/
   int         rce         =  -10;
   /*---(header)-------------------------*/
...
char       /*--> verify line is active ---------------------------------------*/
yDLST_active_check      (char *a_title, void **a_list)
{
   /*---(locals)-----------+-----+-----+-*/
   char        rce         =  -10;
   char        rc          =    0;
   ...
   /*---(walk actives)-------------------*/
   for (x_line = s_head; x_line != NULL; x_line = x_line->a_next) {
      DEBUG_YDLST  yLOG_point   ("x_line"    , x_line);
